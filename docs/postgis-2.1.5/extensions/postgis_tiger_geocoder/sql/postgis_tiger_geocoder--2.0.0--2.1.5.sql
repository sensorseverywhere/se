...
SELECT pg_catalog.setval('pagc_rules_id_seq', 10000, true);--$Id: pagc_normalize_address.sql 11332 2013-05-01 05:05:16Z robe $-
...
$$
  LANGUAGE plpgsql IMMUTABLE
  COST 100;--$Id: other_helper_functions.sql 9324 2012-02-27 22:08:12Z pramsey $
 /*** 
 * 
